 ...
 */
final class Version20220220152615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kiosque CHANGE photo photo VARCHAR(255) NOT NULL, CHANGE id_stade stade_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kiosque DROP FOREIGN KEY FK_636D6C1E6538AB43');
        $this->addSql('DROP INDEX IDX_636D6C1E6538AB43 ON kiosque');
        $this->addSql('ALTER TABLE kiosque CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type type VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE photo photo VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE stade_id id_stade INT DEFAULT NULL');
        $this->addSql('ALTER TABLE kiosque ADD CONSTRAINT FK_636D6C1E6538AB43 FOREIGN KEY (id_stade) REFERENCES stade (id)');
        $this->addSql('CREATE INDEX IDX_636D6C1E6538AB43 ON kiosque (id_stade)');
