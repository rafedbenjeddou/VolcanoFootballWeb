...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('stSLuO6r1s', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dUpM8TrC7k', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.service_locator.GA9CTD_' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_GA9CTDService()
    {
        return $this->privates['.service_locator.GA9CTD_'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L7B0dBAoJL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T3YqVWK8C0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uua6KCNrWW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lsdB5lkHeI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AKrY4ujGaq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.GA9CTD_'] ?? $this->get_ServiceLocator_GA9CTDService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderaf39f = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer9e0dc = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties314f9 = [
        
    ];

    public function getConnection()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getConnection', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getMetadataFactory', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getExpressionBuilder', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'beginTransaction', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getCache', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getCache();
    }

    public function transactional($func)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'transactional', array('func' => $func), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'wrapInTransaction', array('func' => $func), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'commit', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->commit();
    }

    public function rollback()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'rollback', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getClassMetadata', array('className' => $className), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'createQuery', array('dql' => $dql), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'createNamedQuery', array('name' => $name), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'createQueryBuilder', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'flush', array('entity' => $entity), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'clear', array('entityName' => $entityName), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->clear($entityName);
    }

    public function close()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'close', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->close();
    }

    public function persist($entity)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'persist', array('entity' => $entity), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'remove', array('entity' => $entity), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'refresh', array('entity' => $entity), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'detach', array('entity' => $entity), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'merge', array('entity' => $entity), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getRepository', array('entityName' => $entityName), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'contains', array('entity' => $entity), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getEventManager', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getConfiguration', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'isOpen', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getUnitOfWork', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getProxyFactory', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'initializeObject', array('obj' => $obj), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'getFilters', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'isFiltersStateClean', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'hasFilters', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return $this->valueHolderaf39f->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer9e0dc = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderaf39f) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderaf39f = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderaf39f->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, '__get', ['name' => $name], $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        if (isset(self::$publicProperties314f9[$name])) {
            return $this->valueHolderaf39f->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderaf39f;
    ...
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;
    ...
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, '__isset', array('name' => $name), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;
    ...
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, '__unset', array('name' => $name), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;
    ...
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, '__clone', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        $this->valueHolderaf39f = clone $this->valueHolderaf39f;
    }

    public function __sleep()
    {
        $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, '__sleep', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;

        return array('valueHolderaf39f');
    }
    ...
    {
        $this->initializer9e0dc = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer9e0dc;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer9e0dc && ($this->initializer9e0dc->__invoke($valueHolderaf39f, $this, 'initializeProxy', array(), $this->initializer9e0dc) || 1) && $this->valueHolderaf39f = $valueHolderaf39f;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderaf39f;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderaf39f;
    }
}
