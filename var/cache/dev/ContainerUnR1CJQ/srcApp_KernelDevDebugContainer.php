...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KIaHKy5CNl', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nQCxvignZm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.service_locator.qJVPm5i' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_QJVPm5iService()
    {
        return $this->privates['.service_locator.qJVPm5i'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3NdmVoL1UK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M1eTtlQUT2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CgOSUkXL9K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1RvlxBJ6ZZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ph+1XdQ7Qh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getConsole_Command_FormDebugService()
    {
        ...
        $this->privates['console.command.form_debug'] = $instance = new \Symfony\Component\Form\Command\DebugCommand(($this->privates['form.registry'] ?? $this->getForm_RegistryService()), [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type', 1 => 'App\\Form', 2 => 'Symfony\\Bridge\\Doctrine\\Form\\Type'], [0 => 'App\\Form\\BilletType', 1 => 'App\\Form\\EquipeType', 2 => 'App\\Form\\JoueurType', 3 => 'App\\Form\\MatcheType', 4 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType', 5 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType', 6 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 7 => 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType'], [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TransformationFailureExtension', 1 => 'Symfony\\Component\\Form\\Extension\\HttpFoundation\\Type\\FormTypeHttpFoundationExtension', 2 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\FormTypeValidatorExtension', 3 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\RepeatedTypeValidatorExtension', 4 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\SubmitTypeValidatorExtension', 5 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\UploadValidatorExtension', 6 => 'Symfony\\Component\\Form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension', 7 => 'Symfony\\Component\\Form\\Extension\\DataCollector\\Type\\DataCollectorTypeExtension'], [0 => 'Symfony\\Component\\Form\\Extension\\Validator\\ValidatorTypeGuesser', 1 => 'Symfony\\Bridge\\Doctrine\\Form\\DoctrineOrmTypeGuesser'], ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.qJVPm5i'] ?? $this->get_ServiceLocator_QJVPm5iService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder1ffba = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer6e28d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties0b60d = [
        
    ];

    public function getConnection()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getConnection', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getMetadataFactory', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getExpressionBuilder', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'beginTransaction', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getCache', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getCache();
    }

    public function transactional($func)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'transactional', array('func' => $func), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'wrapInTransaction', array('func' => $func), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'commit', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->commit();
    }

    public function rollback()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'rollback', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getClassMetadata', array('className' => $className), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'createQuery', array('dql' => $dql), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'createNamedQuery', array('name' => $name), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'createQueryBuilder', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'flush', array('entity' => $entity), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'clear', array('entityName' => $entityName), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->clear($entityName);
    }

    public function close()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'close', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->close();
    }

    public function persist($entity)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'persist', array('entity' => $entity), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'remove', array('entity' => $entity), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'refresh', array('entity' => $entity), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'detach', array('entity' => $entity), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'merge', array('entity' => $entity), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getRepository', array('entityName' => $entityName), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'contains', array('entity' => $entity), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getEventManager', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getConfiguration', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'isOpen', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getUnitOfWork', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getProxyFactory', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'initializeObject', array('obj' => $obj), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'getFilters', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'isFiltersStateClean', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'hasFilters', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return $this->valueHolder1ffba->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer6e28d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder1ffba) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder1ffba = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder1ffba->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, '__get', ['name' => $name], $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        if (isset(self::$publicProperties0b60d[$name])) {
            return $this->valueHolder1ffba->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1ffba;
    ...
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;
    ...
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, '__isset', array('name' => $name), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;
    ...
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, '__unset', array('name' => $name), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;
    ...
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, '__clone', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        $this->valueHolder1ffba = clone $this->valueHolder1ffba;
    }

    public function __sleep()
    {
        $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, '__sleep', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;

        return array('valueHolder1ffba');
    }
    ...
    {
        $this->initializer6e28d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer6e28d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer6e28d && ($this->initializer6e28d->__invoke($valueHolder1ffba, $this, 'initializeProxy', array(), $this->initializer6e28d) || 1) && $this->valueHolder1ffba = $valueHolder1ffba;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder1ffba;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder1ffba;
    }
}
