 ...
 */
final class Version20220218112337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE billet DROP id_match, DROP date_achat');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE billet ADD id_match INT NOT NULL, ADD date_achat DATE NOT NULL');
