 ...
 */
final class Version20220214210945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueur ADD description VARCHAR(255) DEFAULT NULL');
    }
