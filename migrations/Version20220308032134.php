 ...
 */
final class Version20220308032134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artiste ADD evenement_id INT DEFAULT NULL, DROP id_evenement, DROP prenom, DROP type');
        $this->addSql('ALTER TABLE artiste ADD CONSTRAINT FK_9C07354FFD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id)');
        $this->addSql('CREATE INDEX IDX_9C07354FFD02F13 ON artiste (evenement_id)');
        $this->addSql('ALTER TABLE evenement ADD nom VARCHAR(255) NOT NULL, DROP id_match, DROP id_artiste');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artiste DROP FOREIGN KEY FK_9C07354FFD02F13');
        $this->addSql('DROP INDEX IDX_9C07354FFD02F13 ON artiste');
        $this->addSql('ALTER TABLE artiste ADD id_evenement INT NOT NULL, ADD prenom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD type VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP evenement_id, CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE evenement ADD id_match INT NOT NULL, ADD id_artiste INT NOT NULL, DROP nom');
