 ...
 */
final class Version20220216164330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hebergement CHANGE nom nom_h VARCHAR(255) NOT NULL');
    }
